...
description: Deep codebase researcher using Opus for complex reasoning. Use for architecture analysis, cross-system data flow tracing, or when Sonnet's research output lacks depth.
