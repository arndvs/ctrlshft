...
describe("default Sandcastle template paths", () => {
  it("resolves the source layout under shft/templates", () => {
    const root = createTempDir();
    const workflowDir = path.join(root, "shft", "engine", "workflows");
    const promptsDir = path.join(root, "shft", "templates", "prompts");
