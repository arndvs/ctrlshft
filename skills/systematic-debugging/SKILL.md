...
Output "Read Systematic Debugging skill." to chat to acknowledge your read this file.
...
These techniques are part of systematic debugging and available in the `references/` directory:
