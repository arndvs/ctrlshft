...
3. **Save plan to `working/active/`** — follow the standard handoff protocol (`@~/dotfiles/instructions/handoff.instructions.md`) to persist for cross-conversation pickup. Include @-references to `working/research/<topic>.md`, PRD issue, and key files.
